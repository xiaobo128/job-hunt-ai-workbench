...
export const applicationStageConfig: Record<ApplicationStage, { label: string; badgeClassName: string; order: number; legacy?: boolean }> = {
  ...
  INTERVIEW: { label: "面试", badgeClassName: "bg-violet-50 text-violet-700 ring-violet-200", order: 4 },
  FIRST_INTERVIEW: { label: "一面", badgeClassName: "bg-purple-50 text-purple-700 ring-purple-200", order: 5 },
  SECOND_INTERVIEW: { label: "二面", badgeClassName: "bg-indigo-50 text-indigo-700 ring-indigo-200", order: 6 },
  THIRD_INTERVIEW: { label: "三面", badgeClassName: "bg-indigo-100 text-indigo-800 ring-indigo-200", order: 7 },
