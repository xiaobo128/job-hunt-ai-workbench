...
export function NotificationEventActions({
  ...
  return <>
    <div className="relative">
      <button type="button" aria-label="通知操作" aria-expanded={open} disabled={pending} onClick={() => setOpen((current) => !current)} className="rounded-lg px-2 py-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-700 disabled:opacity-50">···</button>
